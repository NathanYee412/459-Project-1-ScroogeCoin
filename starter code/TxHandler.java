...
public class TxHandler {
	...
	// Updates the transaction pool as a separate function for cleaner looking code
	public void updatePool(Transaction handler) {
		
		// Let's remove the inputs we have verified from the pool
		...
		// Let's add the outputs that are now valid to the pool
